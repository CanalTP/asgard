...
push-app-image-intern: ## Push app-image to intern
	...
	[ "${REGISTRY_HOST}" ] && docker tag asgard-app:${TAG} ${REGISTRY_HOST}/navitia/asgard-app:${TAG} && docker push ${REGISTRY_HOST}/navitia/asgard-app:${TAG} || echo "REGISTRY_HOST is empty"
